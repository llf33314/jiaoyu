package com.gt.education.generator;
...
public class MpGenerator {
    ...
    // 项目的绝对路径
    private static final  String   outPutBaseDir      = "C:/workSpaces/education/education-generator/";
    // 生成*.java 的文件路径
    ...
    // 生成的包路径
    private static final  String   packagePath        = "com.gt.education.generator";
    private static final  String   moduleName         = "";
    // 生成mapper.xml 文件路径
    private static final  String   generatorXmlPath   = outPutBaseDir + "src/main/java/com/gt/education/generator/xml/";
    ...
    // url
    private static final  String   url                = "jdbc:mysql://113.106.202.51:3306/gt_education?characterEncoding=utf8";
    // 数据库用户名
    private static final  String   username           = "root";
    // 密码
    private static final  String   password           = "gt123456";
    // 作者
    private static final String   author             = "chengzhu";
	...
	AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
			...
			new StrategyConfig()
					...
					// 自定义 service 父类
					.setSuperServiceClass( "com.gt.education.base.BaseService" )
					// 自定义 service 实现类父类
					.setSuperServiceImplClass( "com.gt.education.base.BaseServiceImpl" )
					// 自定义 controller 父类
					.setSuperControllerClass( "com.gt.education.base.BaseController" )
